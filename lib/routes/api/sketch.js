...
function setupRoutes(sketchRoute, router) {
    ...
    router.get("/all/:channelId", middleware.userIsLoggedIn, (req, res) => {
        ...
        .catch((e) => {
            //console.log(e);
            return res.status(Constants.HTTP_STATUS_CODES.INTERNAL_SERVER_ERROR).json(new ApiResponse(Constants.RESPONSEMESSAGES.SKETCH_NOT_FOUND, e));
        });
    });
    ...
    router.post("/new/:channelId", middleware.userIsLoggedIn, (req, res) => {
        ...
        .catch((e) => {
            //console.log(e);
            return res.status(Constants.HTTP_STATUS_CODES.INTERNAL_SERVER_ERROR).json(new ApiResponse(Constants.RESPONSEMESSAGES.SKETCH_NOT_CREATED, e));
        });
    });
    ...
    router.post("/save/:channelId", middleware.userIsLoggedIn, (req, res) => {
        ...
        .catch((e) => {
            //console.log(e);
            return res.status(Constants.HTTP_STATUS_CODES.INTERNAL_SERVER_ERROR).json(new ApiResponse(Constants.RESPONSEMESSAGES.SKETCH_NOT_SAVED, e));
        });
    });
    ...
    router.post("/upvote/:sketchId", middleware.userIsLoggedIn, (req, res) => {
        ...
        .catch((e) => {
            //console.log(e);
            return res.status(Constants.HTTP_STATUS_CODES.INTERNAL_SERVER_ERROR).json(new ApiResponse(Constants.RESPONSEMESSAGES.NOT_ADDED_TO_UPVOTES, e));
        });
    });
    ...
    router.post("/downvote/:sketchId", middleware.userIsLoggedIn, (req, res) => {
        ...
        .catch((e) => {
            //console.log(e);
            return res.status(Constants.HTTP_STATUS_CODES.INTERNAL_SERVER_ERROR).json(new ApiResponse(Constants.RESPONSEMESSAGES.NOT_ADDED_TO_DOWNVOTES, e));
        });
    });
    ...
    router.post("/finalize-create/:channelId", middleware.userIsLoggedIn, (req, res) => {
        ...
        channelPromise.then(channel => {
            ...
            sketchPromise.then((newSketch) => {
                ...
                //console.log(e);
                return res.status(Constants.HTTP_STATUS_CODES.INTERNAL_SERVER_ERROR).json(new ApiResponse(Constants.RESPONSEMESSAGES.SKETCH_FINALIZE_FAILED, e));
            });
        }).catch((e) => {
            //console.log(err);
            return res.status(Constants.HTTP_STATUS_CODES.OK).json(new ApiResponse(Constants.RESPONSEMESSAGES.SKETCH_FINALIZE_FAILED,e));
        });
    });
    ...
    router.post("/publish/:sketchId", middleware.userIsLoggedIn, (req, res) => {
        ...
        .catch((e) => {
            //console.log(e);
            return res.status(Constants.HTTP_STATUS_CODES.INTERNAL_SERVER_ERROR).json(new ApiResponse(Constants.RESPONSEMESSAGES.SKETCH_PUBLISH_FAILED, e));
        });
    });
}
