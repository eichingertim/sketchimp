...
function setupRoutes(sketchRoute, router) {
    ...
    router.get("/all/:channelId", middleware.userIsLoggedIn, (req, res) => {
        let channelPromise = getChannelForId(req.params.channelId),
        sketchPromise;
        ...
        sketchPromise = SketchRepository.getAllForChannelId(req.params.channelId);
    ...
    router.get("/all-finalized/:channelId", middleware.userIsLoggedIn, middleware.userIsChannelParticipant, (req, res) => {
        ...
        sketchPromise = SketchRepository.getAllFinalizedForChannelId(req.params.channelId);
    ...
    router.get("/current/:channelId", middleware.userIsLoggedIn, middleware.userIsChannelParticipant, (req, res) => {
        ...
        sketchPromise = SketchRepository.getCurrentForChannelId(req.params.channelId);
    ...
    router.post("/new/:channelId", middleware.userIsLoggedIn, (req, res) => {
        ...
        sketchPromise = SketchRepository.createNewForChannelId(req.params.channelId, req.body.name);
        if(!sketchPromise){
    ...
    router.get("/:sketchId", middleware.userIsLoggedIn, (req, res) => {
        let sketchPromise = SketchRepository.getForId(req.params.sketchId);
    ...
    router.post("/save/:channelId", middleware.userIsLoggedIn, (req, res) => {
        ...
        sketchPromise = SketchRepository.updateCurrentSketchForChannelId(req.params.channelId, req.body);
        if(!sketchPromise){
            console.log(Constants.RESPONSEMESSAGES.SKETCH_NOT_CREATED);
    ...
    router.post("/upvote/:sketchId", middleware.userIsLoggedIn, (req, res) => {
        let sketchPromise = SketchRepository.addUserToUpvotes(req.params.sketchId, req.params.user._id);
    ...
    router.post("/downvote/:sketchId", middleware.userIsLoggedIn, (req, res) => {
        let sketchPromise = SketchRepository.addUserToDownvotes(req.params.sketchId, req.params.user._id);
