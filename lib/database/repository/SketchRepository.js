...
function handleUpvote(sketch, userId){
    if(checkUserIdInList(sketch.downvotes)){
...
function handleDownvote(sketch, userId){
    if(checkUserIdInList(sketch.upvotes)){
    ...
    userUpvoteClick(sketchId, userId){
        ...
        return Sketch.findById(sketchId).then((sketch) => {
            if(checkUserIdInList(sketch.downvotes, userId)) {
                ...
                sketch = handleUpvote(sketch, userId);
            }
            sketch.save();
            return new RefactoredSketch(sketch);
        })
    ...
    userDownvoteClick(sketchId, userId){
        ...
        return Sketch.findById(sketchId).then((sketch) => {
            if(checkUserIdInList(sketch.downvotes, userId)) {
                ...
                sketch = handleDownvote(sketch, userId);
            }
            sketch.save();
            return new RefactoredSketch(sketch);
        })
