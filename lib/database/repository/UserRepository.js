...
/**
 * Provides a standardized Class for returning user data as JSON
 */
 ...
 * return User Data depending on the method that is called
 */
...
class UserRepository extends Observable {
    ...
    removeChannelFromList(user, channelId) {
        ...
        return this.updateLastUsedChannel(user, undefined);
    }
