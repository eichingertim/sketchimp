    ...
    io.on("connection", (client) => {
        ...
        client.on("clear-canvas", (data) => {
            ...
            if (data.sketchData !== null) {
                io.in(data.channelId).emit("clear-canvas", {sketchData: data.sketchData, userRole: null});
            } else if (data.userRole !== null){
                io.in(data.channelId).emit("clear-canvas", {sketchData: null, userRole: data.userRole});
            }
        });
    });
}
